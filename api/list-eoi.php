...
<html lang="en">
    <head>
        ...
        <meta name="description" content="List processing PHP for PowerUp">
		<meta name="keywords" content="PowerUp, list database, IT">
		<meta name="author" content="Levenspeil Sangalang">
        <title>PowerUp &#8211; Records List</title>
        ...
        <main>
            <?php  
                ...
                if (!$conn){
                    ...
                    $listquery = "select * from $sql_table";
                    ...
                    if (!$listresult) {
                        ...
                        ."<div id=\"center-colß2\">\n"
                        ."<h1 class=\"center-align\">Something is wrong with ", $listquery, "</h1>"
                        ."</div>\n"
                        ."</section>\n"
                        ."</div>\n"; 
                    } else {
                        ...
                        echo "<div class=\"app-form\">\n"
                            ."<section class=\"job-top\">\n"   
                            ."<h1 class=\"center-align\">Showing all EOI records</h1>\n" 
                            ."<div id=\"center-col2\">\n"
                            ."<div class=\"roundbox\">\n"  
                            ."<table>\n"  
                            ."<thead>\n" 
